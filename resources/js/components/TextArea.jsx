        ...
        <div className="w-full absolute bottom-0">
            ...
            >
                <input
                    name="message"
                    id="message"
                    className="text-xs border  mb-1 appearance-none block w-10/12 m-auto bg-gray-200 text-gray-700 border border-gray-500  py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 resize-none"
